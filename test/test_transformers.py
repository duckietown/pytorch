...
isSM8687or89Device = torch.cuda.is_available() and torch.cuda.get_device_capability() in [(8, 6), (8,7), (8, 9)]
...
class TestSDPAFailureModes(NNTestCase):
    ...
    @onlyCUDA
    @unittest.skipIf(not PLATFORM_SUPPORTS_FLASH_ATTENTION or not isSM8687or89Device,
...
class TestSDPACudaOnly(NNTestCase):
    ...
    def test_flash_attention_vs_math_ref_grads(self, device, batch_size: int, seq_len_q: int, seq_len_k: int,
        ...
        if isSM8687or89Device and head_dim in range(193, 256 + 1):
        ...
        if isSM8687or89Device and head_dim in range(193, 256):
